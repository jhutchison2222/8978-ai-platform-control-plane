...
7. Confirm a genuine exact-head Claude initial review may provide technical clearance through explicit acceptance/approval or unambiguous whole-review no-issues/no-errors wording. Confirm a genuine exact-head re-review may provide technical clearance through the canonical “Nothing new to post” response only when an earlier genuine Claude review exists. Exact-head CI must pass and every review thread must be resolved. Mixed or caveated wording, silence, deferral, explicit rejection, actionable findings, dismissed reviews, untrusted comments, stale-head reviews, failed/pending CI, and unresolved threads remain fail-closed. Owner authorization remains separate from technical clearance.
