/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: a1d2855562d6ba1bbfba03e3fd937748)
// Runtime types generated with workerd@1.20260811.1 2026-08-12 nodejs_compat
interface __BaseEnv_Env {
	AUTHORITY_DB: D1Database;
	...
	IDEMPOTENCY_STORE: DurableObjectNamespace<import("./src/control-plane-worker").IdempotencyStateDurableObject>;
	OWNER_DECISION_STORE: DurableObjectNamespace<import("./src/control-plane-worker").OwnerDecisionStateDurableObject>;
	AUDIT_STORE: DurableObjectNamespace<import("./src/control-plane-worker").AuditStateDurableObject>;
	ORCHESTRATOR_WORKFLOW: Workflow<Parameters<import("./src/control-plane-worker").OrchestratorWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/control-plane-worker");
		durableNamespaces: "ServiceAuthReplayDurableObject" | "IdempotencyStateDurableObject" | "OwnerDecisionStateDurableObject" | "AuditStateDurableObject";
	}
